...
class SearchController extends Controller
{
    public function index()
    {
        ...
        return view('q2e.search', compact('venues'));
    }
    ...
    //     $venues = '';
    //     $venues += Venue::with('location')->where('location_id', 'LIKE', '%' . $q . '%')->get();
    //     $venues += Venue::with('event_types')->where('location_id', 'LIKE', '%' . $q . '%')->get();
