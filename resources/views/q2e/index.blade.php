...
<div class="slide-one-item home-slider owl-carousel">
    ...
    <div class="site-blocks-cover" style="background-image: url({{ $featuredVenue['hero_img'] }});" data-aos="fade" data-stellar-background-ratio="0.5">
      ...
      <form class="row mb-5">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="select-wrap">
              ...
              <input type="number" name="people_amount" id="people_amount" class="form-control d-block rounded-0" min="">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4 mb-4">
            <a href="{{  $eventType->slug}}" class="service text-center border rounded">
