                ...
                <div class="col-lg-8" style="margin-top: -150px;">
                    <div class="mb-5">
                        <div class="slide-one-item home-slider owl-carousel">
                            <div><img src="{{asset('images/img_2.jpg')}}" alt="{{ $venue->name }}"
                                      class="img-fluid"></div>
                        </div>
                    </div>
                    <div class="bg-white">
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
                                <a href="{{asset('images/img_6.jpg')}}" class="image-popup gal-item">
                                    <img src="{{asset('images/img_6.jpg')}}" alt="{{ $venue->name }}" class="img-fluid">
                                </a>
                            </div>

                            <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
                                <a href="{{asset('images/img_4.jpg')}}" class="image-popup gal-item">
                                    <img src="{{asset('images/img_4.jpg')}}" alt="{{ $venue->name }}" class="img-fluid">
                                </a>
                            </div>

                            <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
                                <a href="{{asset('images/img_2.jpg')}}" class="image-popup gal-item">
                                    <img src="{{asset('images/img_2.jpg')}}" alt="{{ $venue->name }}" class="img-fluid">
                                </a>
                            </div>
                            <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
                                <a href="{{asset('images/img_5.jpg')}}" class="image-popup gal-item">
                                    <img src="{{asset('images/img_5.jpg')}}" alt="{{ $venue->name }}" class="img-fluid">
                                </a>
                            </div>
                ...
                @foreach ($relatedVenues as $venue)
                    <div class="col-md-6 col-lg-4 mb-4">
                        <a href="{{ route('venues.show', [$venue->slug, $venue->id]) }}" class="prop-entry d-block">
                            <figure>
                                <img src="{{asset('images/img_7.jpg')}}" alt="{{ $venue->name }}" class="img-fluid">
                            </figure>
                            <div class="prop-text">
                                <div class="inner">
